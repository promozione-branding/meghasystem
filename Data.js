...
export const categories = [
  ...
  
  {
    id: "toilet-cubicle",
    name: "Toilet Cubicle ",
    metaTitle: "Our Mall Toilet Cubicles are manufactured using premium Compact Laminate",
    metaDescription:
      "Our Mall Toilet Cubicles are manufactured using premium Compact Laminate.",
      ...
      // product 1
{
  ...
  features: [
    ...
    "Scratch, moisture and impact resistant surface for long service life.",
    "Stainless Steel 304 grade hardware ensures corrosion-free performance.",
    "Easy to clean, hygienic and low maintenance design.",
    "Available in multiple colors, finishes and customized sizes."
  ],
  ...
  description: [
    ...
    },
    {
      ...
      items: [
        ...
        "Suitable for shopping malls, airports, hotels, educational institutions, hospitals and office buildings."
      ]
    },
    ...
    },
    {
      type: "ul",
      items: [
        "Material – High Pressure Compact Laminate (HPL).",
        "Thickness – Available in 12mm & 18mm panels.",
        "Hardware – Premium Stainless Steel 304 Grade fittings.",
        "Height – Standard 1950mm (Customizable).",
    ...
    {
      type: "h2",
      text: "Why Choose Megha Systems?"
    },
    {
      type: "ul",
      items: [
        "Leading manufacturer of premium toilet cubicle systems.",
        "High-quality Compact Laminate panels sourced for maximum durability.",
        "Precision engineered Stainless Steel hardware for smooth operation.",
        "Customization available in colors, dimensions and layouts.",
        "Professional installation support and PAN India project execution.",
        "Competitive pricing with assured quality and timely delivery."
      ]
    }
  ],
  ...
  specs: [
    ...
    },
    {
      ...
      value: "1950mm (Customizable)"
    },
    {
      label: "Partition Width",
      value: "600mm - 900mm (Customizable)"
    },
    {
      label: "Door Width",
      value: "600mm - 750mm (Customizable)"
    },
    {
      label: "Hardware",
      value: "Stainless Steel 304 Grade"
    },
    {
      label: "Legs",
      value: "Adjustable Stainless Steel"
    },
    {
      label: "Color Options",
      value: "Solid Colors & Wood Finishes"
    },
    {
      label: "Fire Rating",
      value: "B1 Grade Fire Retardant"
    },
    {
      label: "Application",
      value: "Commercial & Public Washrooms"
    }
  ],
